...
If you cannot install from the repository, install manually:

1. Download the plugin from the WordPress plugin repository: https://wordpress.org/plugins/webhotelier/
